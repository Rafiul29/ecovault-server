...
export class RAGService {
    ...
    async generateAnswer(query: string, limit = 5, sourceType?: string, asJson: boolean = false) {
        ...
        try {
            ...
            // console.log("🚀 ~ RAGService ~ generateAnswer ~ asJson:", asJson)
            // console.log("🚀 ~ RAGService ~ generateAnswer ~ answer:", answer)
            if (asJson) {
                try {
